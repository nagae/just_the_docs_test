...
\end{equation}
$$
ここで，$S(t)$は時点$t$における風呂水の量（ストック），$f(s)$は時点$s=0,1,2,\cdots,t$の期初から期末までに単位時間あたりに流れ込む水の量（フロー）である．
...
ある事業において，時点$s=0, 1, 2, \cdots, t$の期末に発生するキャッシュ・フロー$f(s)$が与えられたとき，その現在価値は以下の式で表される：
$$
\begin{equation}
